...
*/
  // Authentication
    ...
    // Dokter pemeriksaan
    Route::get('/dokter/pemeriksaan/index', [PemeriksaanController::class, 'indexdokter']);
    ...
    Route::get('/admin/hasil_periksa/hasil_periksaPDF', [HasilPeriksaController::class, 'hasil_periksaPDF']);
    Route::get('/admin/hasil_periksa/personalPDF/{id}', [PendaftaranController::class, 'personalPDF']);
    ...
    Route::get('/admin/diagnosa/edit/{id}', [DiagnosaController::class, 'edit']);
    Route::post('/admin/diagnosa/update/{id}', [DiagnosaController::class, 'update']);
